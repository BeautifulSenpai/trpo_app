...
import 'package:trpo_app/screens/admin_screen/all_students_screen.dart';
    ...
    return Scaffold(
      ...
      body: PageView(
        ...
        children: [
          ...
          const AdminScreen(),
          AllStudentsScreen(), // Define a new StudentsScreen class
        ],
        onPageChanged: (index) {
          setState(() {
